...
from . import views
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, CommentCreateView, AJPostView
...
urlpatterns = [
    ...
    path('post/new/', AJPostView.as_view(), name='post-create'),
